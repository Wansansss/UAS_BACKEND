...
class OrderController extends Controller
{
    ...
    }//fungsi untuk menambahkan order ke db
    ...
    }//fungsi untuk menambahkan order baru ke db
    ...
    }//fungsi untuk menampilkan semua data order yang ada di db

    public function pendingOrders(){
        $orders = Order::where('order_status','=','0')->get();
        return view('Admin.pending_orders',compact('orders'));
    }//fungsi untuk menampilkan semua data order berstatus pending yang ada di db

    public function deliveredOrders(){
        $orders = Order::where('order_status','!=','0')->get();
        return view('Admin.delivered_orders',compact('orders'));
    }//fungsi untuk menampilkan semua data order berstatus delvered yang ada di db
}

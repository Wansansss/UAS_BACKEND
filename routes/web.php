...
Route::get('/edit-product/{id}',[ProductController::class,'productEdit'])->middleware(['auth']);
Route::post('/update-product',[ProductController::class,'updateProducts'])->middleware(['auth']);

Route::delete('/delete-product',[ProductController::class,'delete'])->middleware(['auth'])->name('delete.product');
//routing product end

//routing invoice start
...
Route::post('/delete', [InvoiceController::class,'delete'])->middleware(['auth'])->name('delete');
//routing invoice end
...
Route::get('/edit-customer/{id}',[CustomerController::class,'customersEdit'])->middleware(['auth']);
Route::post('/update-customer',[CustomerController::class,'storeCustomers'])->middleware(['auth']);
Route::delete('/delete-customer',[CustomerController::class,'delete'])->middleware(['auth'])->name('delete.customer');
